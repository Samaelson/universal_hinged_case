...
// See Also: 
// Usage:
//   case_body(x_o, y_0, z_o, [x_d=], [y_d=], [z_d=], [z_lbr=]);
// Description:
...
module case_body(x_o=50,y_o=100,z_o=50,x_d=20,y_d=20,z_d=5,z_lbr=0.2){
    ...
    z_h = (z_o + z_d + t) < 20 ? 20 : (z_o + z_d + t);

    z_cut = tan((90-atan2(y_h,(z_h*z_lbr))))*y_h > z_h-10 ? z_h-10 : tan(90-atan2(y_h,(z_h*z_lbr)))*y_h;     
...
// See Also: 
// Usage:
//   case_lid(x_o, y_0, z_o, [x_d=], [y_d=], [z_d=], [z_lbr=], [a=]);
// Description:
...
case_lid(x_object,y_object,z_object,x_space,y_space,z_space,z_lbr=lid_body_ratio,a=lid_opening_angle);
case_body(x_object,y_object,z_object,x_space,y_space,z_space,z_lbr=lid_body_ratio);
